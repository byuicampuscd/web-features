    ...
    ****************************************/
    ...
    function displayOverlay(e) {
        ...
        try {
            ...
            // Set top position
            if (typeof iframe != "undefined" && !iframe.classList.contains('d2l-iframe-fullscreen') && iframe.getClientRects()[0].top < 0) {
                overlay.style.top = Math.abs(iframe.getClientRects()[0].top) + 25 + "px";
